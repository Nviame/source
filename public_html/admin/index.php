<?php
    ...
    $generalData = array(
        ...
        "deliveries" => array(
            "count" => $db->getOne("SELECT COUNT(*) FROM shipments WHERE id_status = 5")
        ),
        "shipments" => array(
            "count" => $db->getOne("SELECT COUNT(*) FROM shipments")
        ),
        "transactions" => array(
            "count" => $db->getOne("SELECT COUNT(*) FROM shipments_payments")
        ),
        "returns" => array(
            "count" => $db->getOne("SELECT COUNT(*) FROM shipments WHERE id_status = 6")
        ),
        "earned" => array(
            "total" => $db->getOne("SELECT IFNULL(SUM(fee_nv), 0) FROM shipments_payments")
        )
    );
?>
<!DOCTYPE html>
                    ...
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 mt-8">
                            <div class="intro-y flex items-center h-10">
                                ...
                                <a href="" class="ml-auto flex text-theme-1"> <i data-feather="refresh-ccw" class="w-4 h-4 mr-3"></i> Refrescar datos </a>
                            </div>
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                <div class="col-span-12 sm:col-span-6 xl:col-span-2 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            <div class="flex">
                                                <i data-feather="users" class="report-box__icon text-theme-16"></i> 
                                                <div class="ml-auto" style="display: none;">
                                                    <div class="report-box__indicator bg-theme-16 tooltip cursor-pointer" title="22% Higher than last month"> 45 <i data-feather="plus" class="w-4 h-4"></i> </div>
                                                </div>
                                            </div>
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $generalData["users"]["count"]; ?></div>
                                    ...
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            <div class="flex">
                                                ...
                                                <div class="ml-auto" style="display: none;">
                                                    <div class="report-box__indicator bg-theme-10 tooltip cursor-pointer" title="22% Higher than last month"> 100 <i data-feather="plus" class="w-4 h-4"></i> </div>
                                                </div>
                                            </div>
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $generalData["deliveries"]["count"]; ?></div>
                                            <div class="text-base text-gray-600 mt-1">Entregas</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6 xl:col-span-2 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            <div class="flex">
                                                ...
                                                <div class="ml-auto" style="display: none;">
                                                    <div class="report-box__indicator bg-theme-11 tooltip cursor-pointer" title="22% Higher than last month"> 180 <i data-feather="plus" class="w-4 h-4"></i> </div>
                                                </div>
                                            </div>
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $generalData["shipments"]["count"]; ?></div>
                                            <div class="text-base text-gray-600 mt-1">Envíos</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6 xl:col-span-2 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            <div class="flex">
                                                <i data-feather="minus-circle" class="report-box__icon text-theme-6"></i> 
                                                <div class="ml-auto" style="display: none;">
                                                    <div class="report-box__indicator bg-theme-6 tooltip cursor-pointer" title="22% Higher than last month"> 195 <i data-feather="plus" class="w-4 h-4"></i> </div>
                                                </div>
                                            </div>
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $generalData["returns"]["count"]; ?></div>
                                            <div class="text-base text-gray-600 mt-1">Devoluciones</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6 xl:col-span-2 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            <div class="flex">
                                                <i data-feather="check-circle" class="report-box__icon" style="color: #2196F3;"></i> 
                                                <div class="ml-auto" style="display: none;">
                                                    <div class="report-box__indicator tooltip cursor-pointer" title="22% Higher than last month" style="background-color: #2196F3;"> 195 <i data-feather="plus" class="w-4 h-4"></i> </div>
                                                </div>
                                            </div>
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $generalData["transactions"]["count"]; ?></div>
                                            <div class="text-base text-gray-600 mt-1">Transacciones</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6 xl:col-span-2 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            <div class="flex">
                                                ...
                                                <div class="ml-auto" style="display: none;">
                                                    <div class="report-box__indicator bg-theme-9 tooltip cursor-pointer" title="22% Higher than last month"> 195 <i data-feather="plus" class="w-4 h-4"></i> </div>
                                                </div>
                                            </div>
                                            <div class="text-3xl font-bold leading-8 mt-6">$ <?php echo $generalData["earned"]["total"]; ?></div>
                                            <div class="text-base text-gray-600 mt-1">Ganancia</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-span-12 xl:col-span-8 mt-6">
                            ...
                            <div class="intro-y box p-5 mt-12 sm:mt-5">
                                ...
                                <div class="report-maps_ mt-5 bg-gray-200 rounded-md" data-center="-6.2425342, 106.8626478" data-sources="/dist/json/location.json"></div>
                            </div>
                        </div>
                        <!-- END: Official Store -->
