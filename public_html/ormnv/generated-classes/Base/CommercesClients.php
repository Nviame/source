...
/**
 * Base class that represents a row from the 'commerces_clients' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class CommercesClients implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CommercesClientsTableMap';
    ...
    /**
     * Initializes internal state of Base\CommercesClients object.
     */
    ...
    /**
     * Compares this with another <code>CommercesClients</code> instance.  If
     * <code>obj</code> is an instance of <code>CommercesClients</code>, delegates to
     * <code>equals(CommercesClients)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CommercesClients The current object, for fluid interface
     */
     ...
     * @return $this|\CommercesClients The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CommercesClientsTableMap::COL_ID] = true;
        }
    ...
    public function setIdCommerce($v)
    {
        ...
        if ($this->id_commerce !== $v) {
            $this->id_commerce = $v;
            $this->modifiedColumns[CommercesClientsTableMap::COL_ID_COMMERCE] = true;
        }
    ...
    public function setIdLocality($v)
    {
        ...
        if ($this->id_locality !== $v) {
            $this->id_locality = $v;
            $this->modifiedColumns[CommercesClientsTableMap::COL_ID_LOCALITY] = true;
        }
    ...
    public function setIdProvince($v)
    {
        ...
        if ($this->id_province !== $v) {
            $this->id_province = $v;
            $this->modifiedColumns[CommercesClientsTableMap::COL_ID_PROVINCE] = true;
        }
    ...
    public function setFullname($v)
    {
        ...
        if ($this->fullname !== $v) {
            $this->fullname = $v;
            $this->modifiedColumns[CommercesClientsTableMap::COL_FULLNAME] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[CommercesClientsTableMap::COL_EMAIL] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[CommercesClientsTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[CommercesClientsTableMap::COL_PHONE] = true;
        }
    ...
    public function setRegisteredAt($v)
    {
        ...
        if ($this->registered_at !== null || $dt !== null) {
            if ($this->registered_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->registered_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[CommercesClientsTableMap::COL_REGISTERED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[CommercesClientsTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CommercesClientsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CommercesClientsTableMap::translateFieldName('IdCommerce', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_commerce = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CommercesClientsTableMap::translateFieldName('IdLocality', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_locality = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CommercesClientsTableMap::translateFieldName('IdProvince', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_province = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CommercesClientsTableMap::translateFieldName('Fullname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fullname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CommercesClientsTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CommercesClientsTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CommercesClientsTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CommercesClientsTableMap::translateFieldName('RegisteredAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->registered_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CommercesClientsTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 10; // 10 = CommercesClientsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CommercesClients'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCommercesClientsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CommercesClients::setDeleted()
     * @see CommercesClients::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCommercesClientsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommercesClientsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[CommercesClientsTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CommercesClientsTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CommercesClientsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_ID_COMMERCE)) {
            $modifiedColumns[':p' . $index++]  = '`id_commerce`';
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_ID_LOCALITY)) {
            $modifiedColumns[':p' . $index++]  = '`id_locality`';
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_ID_PROVINCE)) {
            $modifiedColumns[':p' . $index++]  = '`id_province`';
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_FULLNAME)) {
            $modifiedColumns[':p' . $index++]  = '`fullname`';
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`email`';
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`address`';
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`phone`';
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_REGISTERED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`registered_at`';
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }

        $sql = sprintf(
            'INSERT INTO `commerces_clients` (%s) VALUES (%s)',
    ...
    {
        $pos = CommercesClientsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CommercesClients'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommercesClients'][$this->hashCode()] = true;
        $keys = CommercesClientsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getIdCommerce(),
            $keys[2] => $this->getIdLocality(),
            $keys[3] => $this->getIdProvince(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setIdLocality($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setIdProvince($arr[$keys[3]]);
        }
    ...
    {
        $criteria = new Criteria(CommercesClientsTableMap::DATABASE_NAME);

        if ($this->isColumnModified(CommercesClientsTableMap::COL_ID)) {
            $criteria->add(CommercesClientsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_ID_COMMERCE)) {
            $criteria->add(CommercesClientsTableMap::COL_ID_COMMERCE, $this->id_commerce);
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_ID_LOCALITY)) {
            $criteria->add(CommercesClientsTableMap::COL_ID_LOCALITY, $this->id_locality);
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_ID_PROVINCE)) {
            $criteria->add(CommercesClientsTableMap::COL_ID_PROVINCE, $this->id_province);
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_FULLNAME)) {
            $criteria->add(CommercesClientsTableMap::COL_FULLNAME, $this->fullname);
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_EMAIL)) {
            $criteria->add(CommercesClientsTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_ADDRESS)) {
            $criteria->add(CommercesClientsTableMap::COL_ADDRESS, $this->address);
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_PHONE)) {
            $criteria->add(CommercesClientsTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_REGISTERED_AT)) {
            $criteria->add(CommercesClientsTableMap::COL_REGISTERED_AT, $this->registered_at);
        }
        if ($this->isColumnModified(CommercesClientsTableMap::COL_UPDATED_AT)) {
            $criteria->add(CommercesClientsTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildCommercesClientsQuery::create();
        $criteria->add(CommercesClientsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CommercesClients (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CommercesClients Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProvincesLocalities(ConnectionInterface $con = null)
    {
        if ($this->aProvincesLocalities === null && ($this->id_locality !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProvincesLocalities->addCommercesClientss($this);
             */
        }
    ...
    public function getProvinces(ConnectionInterface $con = null)
    {
        if ($this->aProvinces === null && ($this->id_province !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProvinces->addCommercesClientss($this);
             */
        }
    ...
    {
        if (null !== $this->aProvincesLocalities) {
            $this->aProvincesLocalities->removeCommercesClients($this);
        }
        if (null !== $this->aProvinces) {
            $this->aProvinces->removeCommercesClients($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(CommercesClientsTableMap::DEFAULT_STRING_FORMAT);
    }
