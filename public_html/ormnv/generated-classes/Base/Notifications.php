...
abstract class Notifications implements ActiveRecordInterface
{
    ...
    public function setIdUser($v)
    {
        ...
        if ($this->id_user !== $v) {
            $this->id_user = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_ID_USER] = true;
        }
    ...
    public function setIdShipment($v)
    {
        ...
        if ($this->id_shipment !== $v) {
            $this->id_shipment = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_ID_SHIPMENT] = true;
        }
    ...
    public function setIdOffer($v)
    {
        ...
        if ($this->id_offer !== $v) {
            $this->id_offer = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_ID_OFFER] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_TITLE] = true;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_CONTENT] = true;
        }
    ...
    public function setDatetime($v)
    {
        ...
        if ($this->datetime !== null || $dt !== null) {
            if ($this->datetime === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->datetime->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[NotificationsTableMap::COL_DATETIME] = true;
            }
    ...
    public function setReaded($v)
    {
        ...
        if ($this->readed !== $v) {
            $this->readed = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_READED] = true;
        }
    ...
    public function setGroup($v)
    {
        ...
        if ($this->group !== $v) {
            $this->group = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_GROUP] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : NotificationsTableMap::translateFieldName('IdUser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : NotificationsTableMap::translateFieldName('IdShipment', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_shipment = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : NotificationsTableMap::translateFieldName('IdOffer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_offer = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : NotificationsTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : NotificationsTableMap::translateFieldName('Content', TableMap::TYPE_PHPNAME, $indexType)];
            $this->content = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : NotificationsTableMap::translateFieldName('Datetime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->datetime = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : NotificationsTableMap::translateFieldName('Readed', TableMap::TYPE_PHPNAME, $indexType)];
            $this->readed = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : NotificationsTableMap::translateFieldName('Group', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NotificationsTableMap::COL_ID_USER)) {
            $modifiedColumns[':p' . $index++]  = '`id_user`';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_ID_SHIPMENT)) {
            $modifiedColumns[':p' . $index++]  = '`id_shipment`';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_ID_OFFER)) {
            $modifiedColumns[':p' . $index++]  = '`id_offer`';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`content`';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_DATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`datetime`';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_READED)) {
            $modifiedColumns[':p' . $index++]  = '`readed`';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_GROUP)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) {
            $this->setReaded($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setGroup($arr[$keys[8]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotificationsTableMap::COL_ID_USER)) {
            $criteria->add(NotificationsTableMap::COL_ID_USER, $this->id_user);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_ID_SHIPMENT)) {
            $criteria->add(NotificationsTableMap::COL_ID_SHIPMENT, $this->id_shipment);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_ID_OFFER)) {
            $criteria->add(NotificationsTableMap::COL_ID_OFFER, $this->id_offer);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_TITLE)) {
            $criteria->add(NotificationsTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_CONTENT)) {
            $criteria->add(NotificationsTableMap::COL_CONTENT, $this->content);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_DATETIME)) {
            $criteria->add(NotificationsTableMap::COL_DATETIME, $this->datetime);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_READED)) {
            $criteria->add(NotificationsTableMap::COL_READED, $this->readed);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_GROUP)) {
            $criteria->add(NotificationsTableMap::COL_GROUP, $this->group);
        }
