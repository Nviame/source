...
/**
 * Base class that represents a row from the 'shipments_payments' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class ShipmentsPayments implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ShipmentsPaymentsTableMap';
    ...
    /**
     * Initializes internal state of Base\ShipmentsPayments object.
     */
    ...
    /**
     * Compares this with another <code>ShipmentsPayments</code> instance.  If
     * <code>obj</code> is an instance of <code>ShipmentsPayments</code>, delegates to
     * <code>equals(ShipmentsPayments)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ShipmentsPayments The current object, for fluid interface
     */
     ...
     * @return $this|\ShipmentsPayments The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_ID] = true;
        }
    ...
    public function setIdShipment($v)
    {
        ...
        if ($this->id_shipment !== $v) {
            $this->id_shipment = $v;
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_ID_SHIPMENT] = true;
        }
    ...
    public function setPreferenceId($v)
    {
        ...
        if ($this->preference_id !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_PREFERENCE_ID] = true;
        }
    ...
    public function setCollectionId($v)
    {
        ...
        if ($this->collection_id !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_COLLECTION_ID] = true;
        }
    ...
    public function setCollectionStatus($v)
    {
        ...
        if ($this->collection_status !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_COLLECTION_STATUS] = true;
        }
    ...
    public function setMerchantOrderId($v)
    {
        ...
        if ($this->merchant_order_id !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_MERCHANT_ORDER_ID] = true;
        }
    ...
    public function setTotalPaidAmount($v)
    {
        ...
        if ($this->total_paid_amount !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_TOTAL_PAID_AMOUNT] = true;
        }
    ...
    public function setNetReceivedAmount($v)
    {
        ...
        if ($this->net_received_amount !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_NET_RECEIVED_AMOUNT] = true;
        }
    ...
    public function setRegisteredAt($v)
    {
        ...
        if ($this->registered_at !== null || $dt !== null) {
            if ($this->registered_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->registered_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_REGISTERED_AT] = true;
            }
    ...
    public function setFeeMp($v)
    {
        ...
        if ($this->fee_mp !== $v) {
            $this->fee_mp = $v;
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_FEE_MP] = true;
        }
    ...
    public function setFeeNv($v)
    {
        ...
        if ($this->fee_nv !== $v) {
            $this->fee_nv = $v;
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_FEE_NV] = true;
        }
    ...
    public function setCardTypeId($v)
    {
        ...
        if ($this->card_type_id !== $v) {
            $this->card_type_id = $v;
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_CARD_TYPE_ID] = true;
        }
    ...
    public function setCardMethodId($v)
    {
        ...
        if ($this->card_method_id !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_CARD_METHOD_ID] = true;
        }
    ...
    public function setCardExpirationMonth($v)
    {
        ...
        if ($this->card_expiration_month !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_CARD_EXPIRATION_MONTH] = true;
        }
    ...
    public function setCardExpirationYear($v)
    {
        ...
        if ($this->card_expiration_year !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_CARD_EXPIRATION_YEAR] = true;
        }
    ...
    public function setCardCardholderIdentificationType($v)
    {
        ...
        if ($this->card_cardholder_identification_type !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_IDENTIFICATION_TYPE] = true;
        }
    ...
    public function setCardCardholderIdentificationNumber($v)
    {
        ...
        if ($this->card_cardholder_identification_number !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_IDENTIFICATION_NUMBER] = true;
        }
    ...
    public function setCardCardholderName($v)
    {
        ...
        if ($this->card_cardholder_name !== $v) {
            ...
            $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_NAME] = true;
        }
    ...
    public function setCardDateCreated($v)
    {
        ...
        if ($this->card_date_created !== null || $dt !== null) {
            if ($this->card_date_created === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->card_date_created->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_CARD_DATE_CREATED] = true;
            }
        } // if either are not null
    ...
    public function setCardDateLastUpdated($v)
    {
        ...
        if ($this->card_date_last_updated !== null || $dt !== null) {
            if ($this->card_date_last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->card_date_last_updated->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ShipmentsPaymentsTableMap::COL_CARD_DATE_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('IdShipment', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_shipment = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('PreferenceId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->preference_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CollectionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->collection_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CollectionStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->collection_status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('MerchantOrderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->merchant_order_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('TotalPaidAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_paid_amount = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('NetReceivedAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->net_received_amount = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('RegisteredAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->registered_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('FeeMp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fee_mp = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('FeeNv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fee_nv = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CardTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_type_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CardMethodId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_method_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CardExpirationMonth', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_expiration_month = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CardExpirationYear', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_expiration_year = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CardCardholderIdentificationType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_cardholder_identification_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CardCardholderIdentificationNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_cardholder_identification_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CardCardholderName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_cardholder_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CardDateCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->card_date_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : ShipmentsPaymentsTableMap::translateFieldName('CardDateLastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 20; // 20 = ShipmentsPaymentsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ShipmentsPayments'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildShipmentsPaymentsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ShipmentsPayments::setDeleted()
     * @see ShipmentsPayments::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildShipmentsPaymentsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ShipmentsPaymentsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_ID_SHIPMENT)) {
            $modifiedColumns[':p' . $index++]  = '`id_shipment`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_PREFERENCE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`preference_id`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_COLLECTION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`collection_id`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_COLLECTION_STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`collection_status`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_MERCHANT_ORDER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`merchant_order_id`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_TOTAL_PAID_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = '`total_paid_amount`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_NET_RECEIVED_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = '`net_received_amount`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_REGISTERED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`registered_at`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_FEE_MP)) {
            $modifiedColumns[':p' . $index++]  = '`fee_mp`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_FEE_NV)) {
            $modifiedColumns[':p' . $index++]  = '`fee_nv`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`card_type_id`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_METHOD_ID)) {
            $modifiedColumns[':p' . $index++]  = '`card_method_id`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_EXPIRATION_MONTH)) {
            $modifiedColumns[':p' . $index++]  = '`card_expiration_month`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_EXPIRATION_YEAR)) {
            $modifiedColumns[':p' . $index++]  = '`card_expiration_year`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_IDENTIFICATION_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`card_cardholder_identification_type`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_IDENTIFICATION_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = '`card_cardholder_identification_number`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`card_cardholder_name`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_DATE_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`card_date_created`';
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_DATE_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`card_date_last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `shipments_payments` (%s) VALUES (%s)',
    ...
    {
        $pos = ShipmentsPaymentsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['ShipmentsPayments'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ShipmentsPayments'][$this->hashCode()] = true;
        $keys = ShipmentsPaymentsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_ID)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_ID_SHIPMENT)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_ID_SHIPMENT, $this->id_shipment);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_PREFERENCE_ID)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_PREFERENCE_ID, $this->preference_id);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_COLLECTION_ID)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_COLLECTION_ID, $this->collection_id);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_COLLECTION_STATUS)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_COLLECTION_STATUS, $this->collection_status);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_MERCHANT_ORDER_ID)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_MERCHANT_ORDER_ID, $this->merchant_order_id);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_TOTAL_PAID_AMOUNT)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_TOTAL_PAID_AMOUNT, $this->total_paid_amount);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_NET_RECEIVED_AMOUNT)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_NET_RECEIVED_AMOUNT, $this->net_received_amount);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_REGISTERED_AT)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_REGISTERED_AT, $this->registered_at);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_FEE_MP)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_FEE_MP, $this->fee_mp);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_FEE_NV)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_FEE_NV, $this->fee_nv);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_TYPE_ID)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_CARD_TYPE_ID, $this->card_type_id);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_METHOD_ID)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_CARD_METHOD_ID, $this->card_method_id);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_EXPIRATION_MONTH)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_CARD_EXPIRATION_MONTH, $this->card_expiration_month);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_EXPIRATION_YEAR)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_CARD_EXPIRATION_YEAR, $this->card_expiration_year);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_IDENTIFICATION_TYPE)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_IDENTIFICATION_TYPE, $this->card_cardholder_identification_type);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_IDENTIFICATION_NUMBER)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_IDENTIFICATION_NUMBER, $this->card_cardholder_identification_number);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_NAME)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_CARD_CARDHOLDER_NAME, $this->card_cardholder_name);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_DATE_CREATED)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_CARD_DATE_CREATED, $this->card_date_created);
        }
        if ($this->isColumnModified(ShipmentsPaymentsTableMap::COL_CARD_DATE_LAST_UPDATED)) {
            $criteria->add(ShipmentsPaymentsTableMap::COL_CARD_DATE_LAST_UPDATED, $this->card_date_last_updated);
        }
    ...
    {
        $criteria = ChildShipmentsPaymentsQuery::create();
        $criteria->add(ShipmentsPaymentsTableMap::COL_ID, $this->id);
        $criteria->add(ShipmentsPaymentsTableMap::COL_COLLECTION_ID, $this->collection_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ShipmentsPayments (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ShipmentsPayments Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ShipmentsPaymentsTableMap::DEFAULT_STRING_FORMAT);
    }
