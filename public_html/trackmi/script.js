...
const funcionInit = () => {
	...
	const onUbicacionConcedida = ubicacion => {
		...
		loguear(`${ubicacion.timestamp}: ${coordenadas.latitude},${coordenadas.longitude} -> <a href="http://google.com/maps?q=${coordenadas.latitude},${coordenadas.longitude}">Ver Mapa</a>`);
